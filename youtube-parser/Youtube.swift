...
//  Repaired by Igor Cherny on 8/17/16
...
public class Youtube: NSObject {
  ...
  */
  public static func h264videosWithYoutubeID(youtubeID: String) -> [String: Any]? {
    ...
    group.wait(timeout:  DispatchTime.now() + DispatchTimeInterval.seconds(604800)) // week - 604800sec
